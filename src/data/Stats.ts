...
export const data = [
  ...
  { icon: FaSchool, value: 1054, label: "Sunday Schools" },
  { icon: FaChild, value: 929, label: "Junior Soldiers" },
  { icon: FaUser, value: 117, label: "Corps Cadets" },
  ...
  { icon: FaUserDoctor, value: 31726, label: "Medical Fellowship" },
  ...
  { icon: FaUser, value: 3, label: "Employee" },
];
