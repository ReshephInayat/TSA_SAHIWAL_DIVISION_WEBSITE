    ...
    <div className="min-h-screen bg-gradient-to-r from-black to-[#052146] py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-red-600 to-red-900 bg-clip-text text-transparent">
            New Plantation Projects
          </h1>
          <div className="w-24 h-1 bg-gradient-to-r from-red-600  mx-auto rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            key="chishtian-society"
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
            whileHover={{ scale: 1.01, transition: { duration: 0.2 } }}
            className="rounded-xl overflow-hidden bg-gradient-to-br from-red-900/40 to-gray-900/40  border-red-500/20 shadow-lg"
          >
