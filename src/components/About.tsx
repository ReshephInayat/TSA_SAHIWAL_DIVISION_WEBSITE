...
function About() {
  return (
    <div className="w-full min-h-screen overflow-hidden bg-gray-100 p-8">
        ...
        {cards.map((card, index) => (
          <Link key={card.id} href={card.href} passHref>
            ...
            >
              ...
              {/* Hover Content */}
              <motion.div className="absolute z-30 h-full bottom-0 left-0 w-full bg-gray-950 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out">
